...
const SkillCard = ({ category, idx }: { category: any; idx: number }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-6 md:p-10 rounded-[1.5rem] md:rounded-[2.5rem] bg-[#0B101B] h-full flex flex-col border border-white/5 transition-all duration-500 group-hover:border-accent-primary-500/20">
        ...
        <div className="flex items-center gap-4 mb-6 md:mb-8">
          <div className="p-2 md:p-3 rounded-xl md:rounded-2xl bg-white/5 text-white group-hover:bg-accent-primary-500/10 group-hover:text-accent-primary-500 transition-all duration-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          >
            <div className="text-center group-hover:scale-105 transition-transform duration-700">
              <div className="text-accent-primary-500 font-bold tracking-[0.2em] text-[10px] uppercase mb-6">Continuous Learning</div>
            ...
            <div className="absolute -bottom-1/2 -right-1/2 w-64 h-64 bg-accent-gold-500/10 blur-[80px] rounded-full group-hover:bg-accent-primary-500/10 transition-colors duration-1000" />
          </motion.div>
        </div>
      </div>
    </section>
